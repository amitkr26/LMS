...
<div class="container">
   ...
   <form method="POST" action="add-authors-contro.php">

      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h2> Add Here New Authors</h2>
          </div>
  ...
  <p>
    <input type="submit" id="registration" value="registration" class="btn btn-primary btn-block">
